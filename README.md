...
Ele permite que o usuário foque principalmente na **implementação** das API’s (Web Methods) e automatiza os demais aspectos relacionados a **documentação, exposição, execução e monitoramento** dos serviços.
