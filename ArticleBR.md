...
![](/sites/default/files/inline/images/petstore.gif)
...
![](/sites/default/files/inline/images/soaptooasrest_0.png)
...
![](/sites/default/files/inline/images/xmladaptorcompat_0.png)
...
![](/sites/default/files/inline/images/monitoryourapi.gif)
...
![](/sites/default/files/inline/images/importingpackage.png)
...
![](/sites/default/files/inline/images/labelingimplementationmethod.gif)
...
![](/sites/default/files/inline/images/configuringserviceclass.gif)

## Passo 3
Crie uma Aplicação Web e aponte a classe de Dispatch para a classe de serviço criada anteriomente.
![](/sites/default/files/inline/images/creatingwebapp.gif)
...
![](/sites/default/files/inline/images/testingfirstmethod.gif)

## Defina o cabeçalho da especificação OAS
![](/sites/default/files/inline/images/oasheader.png)
...
![](/sites/default/files/inline/images/customizeyourapi.png)
...
Todas as customizações dadas como exemplo nesta documentação estão disponíveis na classe [apiPub.samples.api](https://github.com/devecchijr/apiPub/blob/base/samples/api.cls).
...
Veja o método ***getPetById*** da classe [apiPub.samples.api](https://github.com/devecchijr/apiPub/blob/base/samples/api.cls)
...
3 - Importe o dashboard de exemplo (***[apiPub_Analytics_vx.xml](https://raw.githubusercontent.com/devecchijr/apiPub/base/apiPub_Analytics_v1.0.xml)***) no portal de administração em *Analytics/Admin/Folder Manager*. Outros dashboards também podem ser criados com base no cubo ***apiPub Monitor***.
...
***Github***: [apiPub](https://github.com/devecchijr/apiPub#iris-apipub)